...
nav.innerHTML='<button class="n4-x" aria-label="Close menu">✕</button>'+links+
 '<div class="n4-soc">GITHUB <a href="https://github.com/Yosa-Shiawase/404startup" target="_blank" rel="noopener">@YOSA-SHIAWASE</a> · INSTAGRAM <a href="https://www.instagram.com/yosashiawase/" target="_blank" rel="noopener">@YOSASHIAWASE</a> · <a href="https://www.linkedin.com/in/yosa-shiawase" target="_blank" rel="noopener">LINKEDIN</a></div>';
